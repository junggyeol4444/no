...
터미널·명령어 없이 쓰려면 → **[`사용법.md`](사용법.md)**. 요약:

1. [Node.js](https://nodejs.org/ko) 설치 (딱 한 번, LTS 버튼)
2. 운영체제에 맞는 파일 **더블클릭**:
   - 윈도우 → `실행-윈도우.bat`  ·  맥 → `실행-맥.command`  ·  리눅스 → `실행-리눅스.sh`
3. 잠시 뒤 브라우저가 자동으로 열립니다.

아래 “빠른 시작”은 개발자용(터미널) 방법입니다.
